...
export class LessonProgressService {
  ...
  static async markComplete(
    ...
    const lesson = await LessonProgressRepository.findPublishedLesson(
      lessonId,
      courseId,
      organizationId,
      branchId,
    ...
    await LessonProgressRepository.markCompleted(enrollment.id, lessonId);

    const totalLessons = await LessonProgressRepository.countPublishedLessons(
      courseId,
      organizationId,
      branchId,
    );
    ...
    const completedLessons =
      await LessonProgressRepository.countCompletedLessons(enrollment.id);
